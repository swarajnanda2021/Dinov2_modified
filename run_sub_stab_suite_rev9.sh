#!/bin/bash
# run_sub_stab_suite_rev9.sh -- parametrized launcher for the "new-baseline" ViT-B ablations.
#
...
echo "  Verifying rev9 hand-rolled DP + loss tuning is present..."
...
echo "    rev9 hand-rolled DP + loss tuning verified."
