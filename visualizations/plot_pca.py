...
def main():
    ...
    wsi_paths = {
        'LUAD': "/path/to/TCGA-LUAD/example_slide.svs",
        'SARC': "/path/to/TCGA-SARC/example_slide.svs",
        'ACC': "/path/to/TCGA-ACC/example_slide.svs",
        'BLCA': "/path/to/TCGA-BLCA/example_slide.svs",
        'KIRC': "/path/to/TCGA-KIRC/example_slide.svs",
    }
